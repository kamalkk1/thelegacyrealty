...
import { MapPin, Crown, TreePine, Landmark, MapIcon } from "lucide-react";
        ...
        >
          <Card className="p-8 border-0 relative before:absolute before:inset-0 before:bg-white before:-z-[1] bg-white/100 backdrop-blur-xl shadow-lg hover:shadow-xl transition-all duration-300">
            <CardContent className="text-center">
              ...
              <h3 className="text-xl font-semibold font-poiret mb-3">Capital Status</h3>
          ...
          <Card className="p-8 border-0 relative before:absolute before:inset-0 before:bg-white before:-z-[1] bg-white/100 backdrop-blur-xl shadow-lg hover:shadow-xl transition-all duration-300">
            <CardContent className="text-center">
              ...
              <h3 className="text-xl font-semibold font-poiret mb-3">UNESCO Heritage</h3>
              <p className="text-gray-600 font-inter">
          ...
          <Card className="p-8 border-0 relative before:absolute before:inset-0 before:bg-white before:-z-[1] bg-white/100 backdrop-blur-xl shadow-lg hover:shadow-xl transition-all duration-300">
            <CardContent className="text-center">
              ...
              <h3 className="text-xl font-semibold font-poiret mb-3">Green Paradise</h3>
              <p className="text-gray-600 font-inter">
